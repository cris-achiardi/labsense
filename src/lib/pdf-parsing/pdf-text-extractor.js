...
exports.extractLabReportSections = extractLabReportSections;
exports.detectLabReportFormat = detectLabReportFormat;
...
if (typeof globalThis.CanvasPattern === 'undefined') {
    globalThis.CanvasPattern = class {
    };
}
 ...
 */
function cleanChileanLabText(text) {
    return text
 ...
 */
function extractLabReportSections(text) {
    const sections = {
        patientInfo: '',
        labResults: '',
        referenceRanges: '',
 ...
 */
function detectLabReportFormat(text) {
